using Firebase.Auth;
using firebaseApplication.authentication;
...
namespace firebaseApplication.controller
{
    public class Controller
    {
        ...
        FirebaseAuthentication firebaseAutentication;
        ...
        public async Task<FirebaseAuthLink> login(string login, string password)
        {
            try
            {
                ...
                this.firebaseDatabase = new FirebaseDatabase(this.userLogged.FirebaseToken);
         ...
         * 
         */
        public async Task<object> getListPasswords()
        {
            try
            {
